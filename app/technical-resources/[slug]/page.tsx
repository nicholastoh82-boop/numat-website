          ...
          <div className="grid gap-8 lg:grid-cols-[260px_minmax(0,1fr)] xl:grid-cols-[280px_minmax(0,1fr)]">
            <aside className="hidden lg:block">
              <div className="sticky top-28">
                <Link
                  href="/technical-resources"
                  className="flex w-full items-start gap-3 rounded-2xl border border-stone-200 bg-white px-4 py-4 text-sm font-semibold text-stone-900 shadow-lg transition hover:bg-stone-50 hover:shadow-xl"
                >
                  <ArrowLeft className="mt-0.5 h-4 w-4 shrink-0 text-emerald-800" />
