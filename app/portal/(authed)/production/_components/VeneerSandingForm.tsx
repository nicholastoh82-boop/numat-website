...
export default function VeneerSandingForm({ userEmail, onSubmitted }: { userEmail: string; onSubmitted: () => void }) {
  ...
  const isValid = i > 0 && p >= 0 && d >= 0 && p + d <= i
  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-xs text-gray-500 mt-0.5">Defects are removed from veneer inventory.</p>
      </div>
