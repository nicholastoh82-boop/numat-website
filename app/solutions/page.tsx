...
export const metadata: Metadata = {
  ...
  description:
    'Finished engineered bamboo systems built from NuWev and NuBrid: decorative indoor wall cladding, and furniture and cabinetry.',
          ...
          <div className="mx-auto max-w-7xl px-6 py-12 lg:px-8 lg:py-16">
            <div className="max-w-3xl">
              ...
              <p className="mt-4 text-lg leading-8 text-stone-600">
                ...
                NuBrid. Woven bamboo wall cladding, and furniture and cabinetry in place of MDF, all
                designed for a clean natural finish.
              </p>
            </div>
          </div>
        </section>
