...
const styles = StyleSheet.create({
  ...
  // --- Balance summary box (partial payments) ---
  balanceBox: {
    marginTop: 8,
    marginBottom: 24,
    padding: 16,
...
type ReceiptData = {
  ...
  // Invoice context (joined from parent quote)
  ...
  // Aggregate: all cumulative payments on this invoice (including this one)
  ...
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        {/* Balance summary (always show for context) */}
        <View style={styles.balanceBox}>
          <Text style={styles.balanceLabel}>Payment Summary</Text>
...
export async function GET(
  ...
  // 3. Resolve parent proforma number if this invoice was converted
  ...
  // 4. Sum cumulative receipts against this invoice up to and including this one
  //    Ordering by created_at so earlier receipts are counted as "before".
  //    We include THIS receipt in the cumulative, so the customer sees the
  //    running total at the moment this payment was acknowledged.
  ...
  const data: ReceiptData = {
    ...
    invoice_type: invoice.invoice_type as any,
