...
export async function GET(
  ...
  try {
    ...
    console.error("Unexpected GET /api/admin/news/[id] error:", error);
    return NextResponse.json(
...
export async function PATCH(
  ...
  try {
    ...
    if (existingError) {
      console.error("Error loading existing news item:", existingError);
      return NextResponse.json(
    ...
    console.error("Unexpected PATCH /api/admin/news/[id] error:", error);
    return NextResponse.json(
      { error: "Unexpected server error." },
      { status: 500 }
    );
...
export async function DELETE(
  ...
  try {
    ...
    console.error("Unexpected DELETE /api/admin/news/[id] error:", error);
    return NextResponse.json(
      { error: "Unexpected server error." },
      { status: 500 }
    );
