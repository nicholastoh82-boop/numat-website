 ...
 * a side by side site test NuForm reached 8 to 10 pours against 4 to 5 for
...
export default function CostPerPourCalculator() {
  ...
  const r = useMemo(() => {
    ...
    // Reuse cycles NuForm must reach to match the conventional cost per pour.
    const breakeven =
        ...
        <div className="flex flex-col gap-4">
          ...
          >
            <p className="text-[11px] font-semibold uppercase tracking-[0.12em] text-stone-600">
              {nuWins ? 'Saving across this job' : 'On these numbers, NuForm costs more'}
            </p>
            ...
            <p className="mt-1 text-xs leading-5 text-stone-600">
              {nuWins
                ...
                : `NuForm needs ${r.breakeven.toFixed(1)} pours to match your current cost per pour. You have assumed ${nuReuse}.`}
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-stone-200 p-5">
            <p className="text-sm leading-6 text-stone-600">
              ...
              <span className="font-semibold text-stone-900">NuForm next to your usual plywood</span>{' '}
